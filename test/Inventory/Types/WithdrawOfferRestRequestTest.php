...
use lliyplliuk\eBaySDK\Inventory\Types\WithdrawOfferRestRequest;
...
class WithdrawOfferRestRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Inventory\Types\WithdrawOfferRestRequest', $this->obj);
    }
