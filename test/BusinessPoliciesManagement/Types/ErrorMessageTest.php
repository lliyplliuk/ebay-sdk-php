...
use lliyplliuk\eBaySDK\BusinessPoliciesManagement\Types\ErrorMessage;
...
class ErrorMessageTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\BusinessPoliciesManagement\Types\ErrorMessage', $this->obj);
    }
