<?php
namespace lliyplliuk\eBaySDK\Test\FileTransfer\Services;

use lliyplliuk\eBaySDK\FileTransfer\Services\FileTransferService;
use lliyplliuk\eBaySDK\FileTransfer\Types;
...
class AttachmentTest extends \PHPUnit_Framework_TestCase
{
    public function testAttachmentFieldIsSetCorrectlyInRequest()
    {
        ...
        $this->assertEquals(null, $r->fileAttachment);
        $s->uploadFile($r);
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\FileTransfer\Types\FileAttachment', $r->fileAttachment);
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\FileTransfer\Types\Data', $r->fileAttachment->Data);
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\FileTransfer\Types\XopInclude', $r->fileAttachment->Data->xopInclude);
