...
use lliyplliuk\eBaySDK\MerchantData\Types\ListingTransactionType;
...
class ListingTransactionTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\MerchantData\Types\ListingTransactionType', $this->obj);
    }
