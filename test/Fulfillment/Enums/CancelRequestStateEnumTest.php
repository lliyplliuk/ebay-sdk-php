...
use lliyplliuk\eBaySDK\Fulfillment\Enums\CancelRequestStateEnum;
...
class CancelRequestStateEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Fulfillment\Enums\CancelRequestStateEnum', $this->obj);
    }
}
