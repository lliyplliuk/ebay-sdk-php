...
use lliyplliuk\eBaySDK\Fulfillment\Enums\OrderPaymentStatusEnum;
...
class OrderPaymentStatusEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Fulfillment\Enums\OrderPaymentStatusEnum', $this->obj);
    }
}
