...
use lliyplliuk\eBaySDK\Fulfillment\Enums\PaymentMethodTypeEnum;
...
class PaymentMethodTypeEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Fulfillment\Enums\PaymentMethodTypeEnum', $this->obj);
    }
}
