...
use lliyplliuk\eBaySDK\Trading\Enums\PayPalAccountStatusCodeType;
...
class PayPalAccountStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Trading\Enums\PayPalAccountStatusCodeType', $this->obj);
    }
}
