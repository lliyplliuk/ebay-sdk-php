...
use lliyplliuk\eBaySDK\Trading\Enums\PaymentMethodSearchCodeType;
...
class PaymentMethodSearchCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Trading\Enums\PaymentMethodSearchCodeType', $this->obj);
    }
}
