...
use lliyplliuk\eBaySDK\Trading\Enums\PaymentInstructionCodeType;
...
class PaymentInstructionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Trading\Enums\PaymentInstructionCodeType', $this->obj);
    }
}
