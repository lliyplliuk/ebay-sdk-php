...
use lliyplliuk\eBaySDK\Trading\Enums\TokenReturnMethodCodeType;
...
class TokenReturnMethodCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Trading\Enums\TokenReturnMethodCodeType', $this->obj);
    }
}
