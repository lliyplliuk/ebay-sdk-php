...
use lliyplliuk\eBaySDK\Trading\Enums\PayPalAccountTypeCodeType;
...
class PayPalAccountTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Trading\Enums\PayPalAccountTypeCodeType', $this->obj);
    }
}
