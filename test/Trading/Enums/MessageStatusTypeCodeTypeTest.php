...
use lliyplliuk\eBaySDK\Trading\Enums\MessageStatusTypeCodeType;
...
class MessageStatusTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Trading\Enums\MessageStatusTypeCodeType', $this->obj);
    }
}
