...
use lliyplliuk\eBaySDK\Trading\Enums\InsuranceSelectedCodeType;
...
class InsuranceSelectedCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Trading\Enums\InsuranceSelectedCodeType', $this->obj);
    }
}
