...
use lliyplliuk\eBaySDK\Trading\Enums\AnnouncementMessageCodeType;
...
class AnnouncementMessageCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Trading\Enums\AnnouncementMessageCodeType', $this->obj);
    }
}
