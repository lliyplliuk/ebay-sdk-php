...
use lliyplliuk\eBaySDK\Trading\Enums\PurchasePurposeTypeCodeType;
...
class PurchasePurposeTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Trading\Enums\PurchasePurposeTypeCodeType', $this->obj);
    }
}
