<?php
namespace lliyplliuk\eBaySDK\Test\Trading\Services;
...
class AuthTokenTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAuthTokenIsUsedInRequst()
    {
        ...
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Trading\Types\CustomSecurityHeaderType', $r->RequesterCredentials);
