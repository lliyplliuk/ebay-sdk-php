...
use lliyplliuk\eBaySDK\Test\Mocks\Base64BinaryType;
use lliyplliuk\eBaySDK\Test\Mocks\BooleanType;
use lliyplliuk\eBaySDK\Test\Mocks\DecimalType;
use lliyplliuk\eBaySDK\Test\Mocks\DoubleType;
use lliyplliuk\eBaySDK\Test\Mocks\IntegerType;
use lliyplliuk\eBaySDK\Test\Mocks\StringType;
use lliyplliuk\eBaySDK\Test\Mocks\TokenType;
use lliyplliuk\eBaySDK\Test\Mocks\URIType;
...
class SimpleClassTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Test\Mocks\SimpleClass', $this->obj);
    }
    ...
    public function testGettingSettingProperties()
    {
        ...
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Test\Mocks\SimpleClass', $this->obj->SimpleClass);

        $this->assertEquals(0, count($this->obj->strings));
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Types\RepeatableType', $this->obj->strings);
        ...
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Types\RepeatableType', $this->obj->integers);
        ...
        $this->assertInstanceOf('\lliyplliuk\eBaySDK\Types\RepeatableType', $this->obj->anyTypes);
        $this->obj->anyTypes[] = 1;
    ...
    {
        $this->setExpectedException('\lliyplliuk\eBaySDK\Exceptions\UnknownPropertyException', 'Unknown property foo');
    ...
    {
        $this->setExpectedException('\lliyplliuk\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integer. Expected integer but got string');
    ...
    {
        $this->setExpectedException('\lliyplliuk\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integers. Expected integer but got string');
    ...
    {
        $this->setExpectedException('\lliyplliuk\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integers. Expected lliyplliuk\eBaySDK\Types\RepeatableType but got integer');
    ...
    public function testCanGetElementMeta()
    {
        ...
        $meta->phpType = 'lliyplliuk\eBaySDK\Test\Mocks\SimpleClass';
