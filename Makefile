...
sync_file:
	...
	sed -i -e "s/@property string/@property \\\lliyplliuk\\\eBaySDK\\\FileTransfer\\\Types\\\Data/" src/FileTransfer/Types/FileAttachment.php
	sed -i -e "s/'string'/'lliyplliuk\\\eBaySDK\\\FileTransfer\\\Types\\\Data'/" src/FileTransfer/Types/FileAttachment.php
