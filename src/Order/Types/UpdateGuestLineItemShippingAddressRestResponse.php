...
/**
 *
 * @property \lliyplliuk\eBaySDK\Order\Types\ErrorDetailV3[] $errors
 * @property \lliyplliuk\eBaySDK\Order\Types\ErrorDetailV3[] $warnings
 */
class UpdateGuestLineItemShippingAddressRestResponse extends \lliyplliuk\eBaySDK\Order\Types\CheckoutSessionResponse
{
    use StatusCodeTrait;
