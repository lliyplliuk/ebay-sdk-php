 ...
 * @property \lliyplliuk\eBaySDK\Browse\Types\Category[] $categories
 * @property string $condition
 * @property string $conditionId
 * @property \lliyplliuk\eBaySDK\Browse\Types\ConvertedAmount $currentBidPrice
 * @property \lliyplliuk\eBaySDK\Browse\Types\TargetLocation $distanceFromPickupLocation
 ...
 * @property \lliyplliuk\eBaySDK\Browse\Types\ItemLocationImpl $itemLocation
 * @property string $itemWebUrl
 * @property \lliyplliuk\eBaySDK\Browse\Types\MarketingPrice $marketingPrice
 * @property \lliyplliuk\eBaySDK\Browse\Types\PickupOptionSummary[] $pickupOptions
 * @property \lliyplliuk\eBaySDK\Browse\Types\ConvertedAmount $price
 * @property \lliyplliuk\eBaySDK\Browse\Types\Seller $seller
 * @property \lliyplliuk\eBaySDK\Browse\Types\ShippingOptionSummary[] $shippingOptions
 * @property \lliyplliuk\eBaySDK\Browse\Types\Image[] $thumbnailImages
 * @property string $title
 */
class ItemSummary extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'categories' => [
            'type' => 'lliyplliuk\eBaySDK\Browse\Types\Category',
            'repeatable' => true,
            'attribute' => false,
        ...
        'distanceFromPickupLocation' => [
            'type' => 'lliyplliuk\eBaySDK\Browse\Types\TargetLocation',
            'repeatable' => false,
            'attribute' => false,
        ...
        'itemLocation' => [
            'type' => 'lliyplliuk\eBaySDK\Browse\Types\ItemLocationImpl',
            'repeatable' => false,
            'attribute' => false,
        ...
        'pickupOptions' => [
            'type' => 'lliyplliuk\eBaySDK\Browse\Types\PickupOptionSummary',
            'repeatable' => true,
            'attribute' => false,
        ...
        'shippingOptions' => [
            'type' => 'lliyplliuk\eBaySDK\Browse\Types\ShippingOptionSummary',
            'repeatable' => true,
            'attribute' => false,
