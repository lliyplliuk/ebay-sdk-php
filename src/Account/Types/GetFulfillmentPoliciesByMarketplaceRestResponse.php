...
/**
 *
 * @property \lliyplliuk\eBaySDK\Account\Types\ErrorDetailV3[] $errors
 * @property \lliyplliuk\eBaySDK\Account\Types\ErrorDetailV3[] $warnings
 */
class GetFulfillmentPoliciesByMarketplaceRestResponse extends \lliyplliuk\eBaySDK\Account\Types\FulfillmentPolicyResponse
{
    use StatusCodeTrait;
