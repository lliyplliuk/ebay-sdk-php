 ...
 */
class ComplianceBaseService extends \lliyplliuk\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \lliyplliuk\eBaySDK\Compliance\Services\ComplianceService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
