 ...
 *
 * @property string $SKU
 * @property \lliyplliuk\eBaySDK\RelatedItemsManagement\Types\Discount $discount
 * @property integer $rank
 * @property string $title
 * @property integer $maxQtyForSinglePrimary
 */
class RelatedProduct extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'discount' => [
            'type' => 'lliyplliuk\eBaySDK\RelatedItemsManagement\Types\Discount',
            'repeatable' => false,
            'attribute' => false,
