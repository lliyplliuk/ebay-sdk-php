...
use lliyplliuk\eBaySDK\Trading\Types;

/**
 * Base class for the Trading service.
 */
class TradingBaseService extends \lliyplliuk\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \lliyplliuk\eBaySDK\Trading\Services\TradingService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string']
    ...
    protected function callOperationAsync($name, \lliyplliuk\eBaySDK\Types\BaseType $request, $responseClass)
    {
        ...
        if ($this->getConfig('authorization') !== null) {
             ...
             */
            if (!isset($request->RequesterCredentials)) {
                $request->RequesterCredentials = new \lliyplliuk\eBaySDK\Trading\Types\CustomSecurityHeaderType();
            }
