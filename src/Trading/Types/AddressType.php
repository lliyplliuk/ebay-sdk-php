 ...
 * @property \lliyplliuk\eBaySDK\Trading\Enums\CountryCodeType $PhoneCountryCode
 * @property string $PhoneCountryPrefix
 * @property string $PhoneAreaOrCityCode
 * @property string $PhoneLocalNumber
 * @property \lliyplliuk\eBaySDK\Trading\Enums\CountryCodeType $Phone2CountryCode
 * @property string $Phone2CountryPrefix
 * @property string $Phone2AreaOrCityCode
 * @property string $Phone2LocalNumber
 * @property string $PostalCode
 * @property string $AddressID
 * @property \lliyplliuk\eBaySDK\Trading\Enums\AddressOwnerCodeType $AddressOwner
 ...
 * @property \lliyplliuk\eBaySDK\Trading\Enums\AddressUsageCodeType $AddressUsage
 * @property string $ReferenceID
 * @property \lliyplliuk\eBaySDK\Trading\Types\AddressAttributeType[] $AddressAttribute
 */
class AddressType extends \lliyplliuk\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'AddressAttribute' => [
            'type' => 'lliyplliuk\eBaySDK\Trading\Types\AddressAttributeType',
            'repeatable' => true,
            'attribute' => false,
