 ...
 * @property \lliyplliuk\eBaySDK\Trading\Enums\StringMatchCodeType $MatchType
 * @property boolean $Featured
 */
class GetCharitiesRequestType extends \lliyplliuk\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
