 ...
 * @property \lliyplliuk\eBaySDK\Trading\Enums\BestOfferActionCodeType $Action
 * @property string $SellerResponse
 * @property \lliyplliuk\eBaySDK\Trading\Types\AmountType $CounterOfferPrice
 * @property integer $CounterOfferQuantity
 */
class RespondToBestOfferRequestType extends \lliyplliuk\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
