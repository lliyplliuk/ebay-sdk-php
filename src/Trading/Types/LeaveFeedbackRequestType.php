 ...
 * @property \lliyplliuk\eBaySDK\Trading\Enums\CommentTypeCodeType $CommentType
 * @property string $TransactionID
 * @property string $TargetUser
 * @property \lliyplliuk\eBaySDK\Trading\Types\ItemRatingDetailArrayType $SellerItemRatingDetailArray
 * @property string $OrderLineItemID
 * @property \lliyplliuk\eBaySDK\Trading\Enums\ItemArrivedWithinEDDCodeType $ItemArrivedWithinEDDType
 * @property boolean $ItemDeliveredWithinEDD
 */
class LeaveFeedbackRequestType extends \lliyplliuk\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'SellerItemRatingDetailArray' => [
            'type' => 'lliyplliuk\eBaySDK\Trading\Types\ItemRatingDetailArrayType',
            'repeatable' => false,
            'attribute' => false,
