 ...
 * @property \lliyplliuk\eBaySDK\Trading\Types\AmountType $EachAdditionalAmountOff
 * @property double $EachAdditionalPercentOff
 * @property \lliyplliuk\eBaySDK\Trading\Types\MeasureType $WeightOff
 * @property string $MappedDiscountProfileID
 */
class DiscountProfileType extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
