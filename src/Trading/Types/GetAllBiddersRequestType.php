 ...
 * @property \lliyplliuk\eBaySDK\Trading\Enums\GetAllBiddersModeCodeType $CallMode
 * @property boolean $IncludeBiddingSummary
 */
class GetAllBiddersRequestType extends \lliyplliuk\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
