 ...
 * @property \lliyplliuk\eBaySDK\MerchantData\Enums\CharityAffiliationTypeCodeType $AffiliationType
 * @property \DateTime $LastUsedTime
 */
class CharityAffiliationDetailType extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
