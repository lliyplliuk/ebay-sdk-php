 ...
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $BidIncrement
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $ConvertedCurrentPrice
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $CurrentPrice
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\UserType $HighBidder
 * @property integer $LeadCount
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $MinimumToBid
 * @property integer $QuantitySold
 * @property boolean $ReserveMet
 * @property boolean $SecondChanceEligible
 * @property integer $BidderCount
 * @property \lliyplliuk\eBaySDK\MerchantData\Enums\ListingStatusCodeType $ListingStatus
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $FinalValueFee
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\PromotionalSaleDetailsType $PromotionalSaleDetails
 * @property boolean $AdminEnded
 * @property boolean $SoldAsBin
 * @property integer $QuantitySoldByPickupInStore
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\SuggestedBidValueType $SuggestedBidValues
 */
class SellingStatusType extends \lliyplliuk\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'PromotionalSaleDetails' => [
            'type' => 'lliyplliuk\eBaySDK\MerchantData\Types\PromotionalSaleDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'SuggestedBidValues' => [
            'type' => 'lliyplliuk\eBaySDK\MerchantData\Types\SuggestedBidValueType',
            'repeatable' => false,
            'attribute' => false,
