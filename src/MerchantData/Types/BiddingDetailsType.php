...
/**
 *
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $ConvertedMaxBid
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $MaxBid
 * @property integer $QuantityBid
 * @property integer $QuantityWon
 * @property boolean $Winning
 */
class BiddingDetailsType extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
