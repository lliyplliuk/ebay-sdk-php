 ...
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $ConvertedBuyItNowPrice
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $ConvertedStartPrice
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $ConvertedReservePrice
 ...
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $MinimumBestOfferPrice
 * @property string $LocalListingDistance
 * @property string $TCROriginalItemID
 * @property string $ViewItemURLForNaturalSearch
 * @property \lliyplliuk\eBaySDK\MerchantData\Types\AmountType $BestOfferAutoAcceptPrice
 * @property \lliyplliuk\eBaySDK\MerchantData\Enums\EndReasonCodeType $EndingReason
 */
class ListingDetailsType extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
