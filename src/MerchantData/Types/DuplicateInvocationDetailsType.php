 ...
 * @property \lliyplliuk\eBaySDK\MerchantData\Enums\InvocationStatusType $Status
 * @property string $InvocationTrackingID
 */
class DuplicateInvocationDetailsType extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
