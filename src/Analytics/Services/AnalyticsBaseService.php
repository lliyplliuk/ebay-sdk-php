<?php
namespace lliyplliuk\eBaySDK\Analytics\Services;

/**
 * Base class for the Analytics service.
 */
class AnalyticsBaseService extends \lliyplliuk\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \lliyplliuk\eBaySDK\Analytics\Services\AnalyticsService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
