 ...
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $actualDeliveryDate
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $actualShipDate
 * @property string $carrierEnum
 * @property integer $carrierId
 * @property string $carrierName
 * @property string $carrierUsed
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $deliveryDate
 * @property \lliyplliuk\eBaySDK\PostOrder\Enums\TrackingStatusEnum $deliveryStatus
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\ReturnAddressType $destinationAddress
 * @property string $errorCode
 * @property string $labelAvailableUntilDate
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $labelDate
 * @property string $labelId
 * @property boolean $labelPrintExpired
 * @property boolean $labelVoidExpired
 * @property boolean $markAsReceived
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $maxDeliveryEstimate
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $minDeliveryEstimate
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\ReturnAddressType $originAddress
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $shipDate
 * @property string $shipmentId
 * @property string $shippedBy
 * @property \lliyplliuk\eBaySDK\PostOrder\Enums\ShippingMethodEnum $shippingMethod
 * @property string $trackingNumber
 */
class ShipmentTrackingType extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
