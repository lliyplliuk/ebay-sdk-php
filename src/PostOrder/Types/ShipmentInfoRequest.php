 ...
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\Text $sellerComments
 * @property boolean $shippedWithTracking
 * @property string $shippingCarrierName
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $shippingDate
 * @property string $trackingNumber
 */
class ShipmentInfoRequest extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
