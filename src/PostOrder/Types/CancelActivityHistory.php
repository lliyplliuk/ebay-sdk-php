...
/**
 *
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $actionDate
 * @property string $activityParty
 * @property \lliyplliuk\eBaySDK\PostOrder\Enums\CancelActivityTypeEnum $activityType
 * @property string $cancelStateFrom
 * @property string $cancelStateTo
 * @property string $cancelStatetateTo
 */
class CancelActivityHistory extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
