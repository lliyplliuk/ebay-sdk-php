...
/**
 *
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $holdCreationDate
 * @property string $holdReferenceId
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $holdReleaseDate
 * @property \lliyplliuk\eBaySDK\PostOrder\Enums\ReturnHoldStatusEnum $holdStatus
 * @property string $holdTransactionId
 */
class ReturnHoldInfoType extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
