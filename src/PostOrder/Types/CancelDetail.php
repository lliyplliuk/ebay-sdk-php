...
/**
 *
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\CancelActivityHistory[] $activityHistories
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $buyerResponseDueDate
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $cancelCloseDate
 * @property string $cancelCloseReason
 * @property string $cancelId
 * @property string $cancelReason
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $cancelRequestDate
 * @property string $itemId
 * @property string $legacyOrderId
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\OrderCancelLineItem[] $lineItems
 * @property \lliyplliuk\eBaySDK\PostOrder\Enums\MarketplaceIdEnum $marketplaceId
 * @property string $paymentStatus
 * @property string $requestorType
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\Amount $requestRefundAmount
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $sellerResponseDueDate
 * @property \lliyplliuk\eBaySDK\PostOrder\Types\DateTime $shipmentDate
 * @property string $cancelState
 * @property string $cancelStatus
 * @property string $transactionId
 */
class CancelDetail extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        'activityHistories' => [
            'type' => 'lliyplliuk\eBaySDK\PostOrder\Types\CancelActivityHistory',
            'repeatable' => true,
            'attribute' => false,
        ...
        'lineItems' => [
            'type' => 'lliyplliuk\eBaySDK\PostOrder\Types\OrderCancelLineItem',
            'repeatable' => true,
            'attribute' => false,
