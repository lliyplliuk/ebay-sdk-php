 ...
 */
class HalfFindingBaseService extends \lliyplliuk\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \lliyplliuk\eBaySDK\HalfFinding\Services\HalfFindingService::API_VERSION
            ],
            'globalId' => [
                'valid' => ['string']
            ]
