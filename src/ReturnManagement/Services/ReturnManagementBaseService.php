 ...
 */
class ReturnManagementBaseService extends \lliyplliuk\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \lliyplliuk\eBaySDK\ReturnManagement\Services\ReturnManagementService::API_VERSION
            ],
            'authToken' => [
                'valid' => ['string'],
                'required' => true
