 ...
 * @property \lliyplliuk\eBaySDK\ResolutionCaseManagement\Enums\AppealReasonType $appealReason
 * @property string $comments
 */
class AppealToCustomerSupportRequest extends \lliyplliuk\eBaySDK\ResolutionCaseManagement\Types\BaseRequest
{
    /**
