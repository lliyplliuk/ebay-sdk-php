 ...
 * @property \lliyplliuk\eBaySDK\Shopping\Enums\ProductSortCodeType $ProductSort
 * @property \lliyplliuk\eBaySDK\Shopping\Enums\SortOrderCodeType $SortOrder
 * @property integer $MaxEntries
 * @property integer $PageNumber
 * @property string $CategoryID
 * @property boolean $HideDuplicateItems
 */
class FindProductsRequestType extends \lliyplliuk\eBaySDK\Shopping\Types\AbstractRequestType
{
    /**
