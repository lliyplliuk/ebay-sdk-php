 ...
 * @property \lliyplliuk\eBaySDK\Shopping\Enums\CountryCodeType $DestinationCountryCode
 * @property boolean $IncludeDetails
 */
class GetShippingCostsRequestType extends \lliyplliuk\eBaySDK\Shopping\Types\AbstractRequestType
{
    /**
