<?php
namespace lliyplliuk\eBaySDK\Services;

use lliyplliuk\eBaySDK\Parser\XmlParser;
...
abstract class BaseService
{
     ...
     */
    protected function callOperationAsync($name, \lliyplliuk\eBaySDK\Types\BaseType $request, $responseClass)
    {
        $url = $this->getUrl();
     ...
     */
    protected function buildRequestBody(\lliyplliuk\eBaySDK\Types\BaseType $request)
    {
     ...
     */
    private function buildXopDocument(\lliyplliuk\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s%s%s',
     ...
     */
    protected function buildMultipartFormDataXMLPayload(\lliyplliuk\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s',
            '--boundary'.self::CRLF,
