 ...
 */
class MarketingBaseService extends \lliyplliuk\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \lliyplliuk\eBaySDK\Marketing\Services\MarketingService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
