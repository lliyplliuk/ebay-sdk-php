...
/**
 *
 * @property \lliyplliuk\eBaySDK\Marketing\Types\Amount $amountOffItem
 * @property \lliyplliuk\eBaySDK\Marketing\Types\Amount $amountOffOrder
 * @property string $percentageOffItem
 * @property string $percentageOffOrder
 */
class DiscountBenefit extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
