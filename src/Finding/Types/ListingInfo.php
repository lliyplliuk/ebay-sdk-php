 ...
 * @property \lliyplliuk\eBaySDK\Finding\Types\Amount $buyItNowPrice
 * @property \lliyplliuk\eBaySDK\Finding\Types\Amount $convertedBuyItNowPrice
 * @property \DateTime $startTime
 * @property \DateTime $endTime
 * @property string $listingType
 * @property boolean $gift
 */
class ListingInfo extends \lliyplliuk\eBaySDK\Types\BaseType
{
    /**
