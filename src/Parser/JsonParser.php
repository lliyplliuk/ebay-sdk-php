...
{
    /**
     * @param mixed A PHP object derived from lliyplliuk\eBaySDK\Types\BaseType
    ...
    private static function assignProperties(\lliyplliuk\eBaySDK\Types\BaseType $object, array $properties)
    {
