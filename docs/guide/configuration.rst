...
This guide describes the service configuration options. These options can be provided in a service constructor or to the ``lliyplliuk\eBaySDK\Sdk`` class.
...
.. code-block:: php
    ...
    use lliyplliuk\eBaySDK\Shopping\Services\ShoppingService;
...
.. code-block:: php
    ...
    use lliyplliuk\eBaySDK\Trading\Services;
...
.. code-block:: php
    ...
    use lliyplliuk\eBaySDK\Browse\Services\BrowseService;
...
:Type: ``array|lliyplliuk\eBaySDK\Credentials\CredentialsInterface|callable``
...
You can also pass an instance of the ``lliyplliuk\eBaySDK\Credentials\CredentialsInterface`` interface.
