...
.. code-block:: php
    ...
    $finding = new lliyplliuk\eBaySDK\Finding\Services\FindingService([
        'apiVersion' => '1.13.0',
        'globalId'   => lliyplliuk\eBaySDK\Constants\GlobalIds::US
    ]);
...
The ``lliyplliuk\eBaySDK\Sdk`` class can be used as a factory for creating services. Configuration options passed to this class are shared with any services that it creates.
...
.. code-block:: php
    ...
    $sdk = new lliyplliuk\eBaySDK\Sdk($config);
